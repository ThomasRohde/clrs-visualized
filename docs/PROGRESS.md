...
> **Next task:** **G4** — `hopcroft-karp` (§25.1) in chapter 25, alone in its batch: it is the only
> row left in Phase G that adds a layer of machinery rather than reusing one. See
...
> **Last completed:** **G3** — `articulation-points` (Prob. 20-2, with bridges) and
